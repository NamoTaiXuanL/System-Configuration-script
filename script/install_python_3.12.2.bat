...
:: Python 3.12.2 Auto Installation Script
:: Features: Detect, Download, Install, Verify

echo ============================================
echo    Python 3.12.2 Auto Installation Script
echo ============================================
echo.
...
set "INSTALLER_FILE=%TEMP%\python-3.12.2-amd64.exe"

:: 3. Download Python installer
echo [2/5] Downloading Python 3.12.2...
...
echo   - Install path: C:\Python312
echo   - Add to PATH: Yes
echo   - Install pip: Yes
echo.

"%INSTALLER_FILE%" /quiet InstallAllUsers=1 TargetDir="C:\Python312" PrependPath=1 Include_test=0
...
if %errorlevel% equ 0 (
    ...
    echo ============================================
    echo.
    echo Python 3.12.2 has been successfully installed to: C:\Python312
    echo Added to system PATH environment variable.
    echo.
    echo Please reopen Command Prompt to use the new PATH settings.
    echo Or run directly: C:\Python312\python.exe
    echo.
) else (
...
if exist "%TEMP%\refresh_env.bat" del "%TEMP%\refresh_env.bat"
